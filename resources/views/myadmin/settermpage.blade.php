...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Set The Terms & Conditions Page
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Pages</a></li>
        <li class="active">Set Terms-Conditions Page</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
       ...
       <form action="{{route('pages.termcon')}}" method="post">
       {{csrf_field()}}
         <div class="row">
         <div class="col-xs-7">
          <div class="form-group has-feedback">
            <textarea class="form-control" name="body" rows="15" cols="150">
              {{ $termscon->terms_conditoin or "No Information Found" }}
            </textarea>  
