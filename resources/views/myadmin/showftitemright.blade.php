...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Show Featured Item Right
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Featured Item Right</a></li>
        <li class="active">Show Featured Item Right</li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                 <tr>
                  ...
                  <th style="text-align: center;" width="20%">Accordian link</th>
              ...
              <?php $i++;?>
                <tr>
                  <td>{{$i}}</td>
                  <td>{{$ftItemRight->title}}</td>
                  <td>{{$ftItemRight->desc}}</td>
                  <td>{{$ftItemRight->accordian_link}}</td>
                  <td>
                     <a href="{{route('featureditemsright.edit',$ftItemRight->id)}}"><button class="btn btn-primary">Edit</button></a>
                  </td>
                  <td>
                    <form method="POST" action="{{action('ftItemRightController@destroy',['id'=>$ftItemRight->id])}}">
                        {{method_field('DELETE')}}
                        {{csrf_field()}}
